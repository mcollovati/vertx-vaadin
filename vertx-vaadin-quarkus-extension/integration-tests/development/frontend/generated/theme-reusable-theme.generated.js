...
import stylesCss from 'themes/reusable-theme/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_reusable-theme_componentCss']) {
    
    document['_vaadintheme_reusable-theme_componentCss'] = true;
  }
