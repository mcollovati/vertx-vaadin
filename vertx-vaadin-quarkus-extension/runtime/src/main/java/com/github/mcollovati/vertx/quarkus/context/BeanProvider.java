...
public final class BeanProvider {
     ...
     * &#064;Dependent beans in
     * {@link #getContextualReference(Class, Annotation...)}!
     * </p>
     *
     * @param name
     ...
     * <b>Attention:</b> please see the notes on manually resolving
     * &#064;Dependent bean in
     * {@link #getContextualReference(Class, boolean, Annotation...)}!
     * </p>
     *
     *
     * @param beanManager
     ...
     * {@link BeanManager#resolve(Set)} which we cannot use in this
     * case!
     * </p>
     *
     * @param type
